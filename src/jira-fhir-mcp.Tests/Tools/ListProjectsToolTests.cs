...
{
    private readonly ListProjectsTool _tool;

    public ListProjectsToolTests()
    {
        _tool = new ListProjectsTool();
    }

    [Fact]
    public void Tool_Should_Have_Correct_Name()
    {
        _tool.Name.ShouldBe("list_projects");
    }

    [Fact]
    public void Tool_Should_Have_Correct_Description()
    {
        _tool.Description.ShouldBe("List all unique projects in the database");
    }
    ...
    public void Should_Have_Correct_McpTool_Structure()
    {
        ...
        // Assert
        mcpTool.Name.ShouldBe("list_projects");
        mcpTool.Description.ShouldBe("List all unique projects in the database");
