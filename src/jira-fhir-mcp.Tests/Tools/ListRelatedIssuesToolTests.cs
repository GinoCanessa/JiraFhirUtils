...
public class ListRelatedIssuesToolTests
{
    private readonly ListRelatedIssuesTool _tool;

    public ListRelatedIssuesToolTests()
    {
        _tool = new ListRelatedIssuesTool();
    }

    [Fact]
    public void Tool_Should_Have_Correct_Name()
    {
        _tool.Name.ShouldBe("list_related_issues");
    }

    [Fact]
    public void Tool_Should_Have_Correct_Description()
    {
        _tool.Description.ShouldBe("Find and list issues related to a specific JIRA issue through explicit links and keyword similarity. Returns both explicitly linked issues and keyword-related issues.");
    }
    ...
    public void Should_Have_Correct_McpTool_Structure()
    {
        ...
        // Assert
        mcpTool.Name.ShouldBe("list_related_issues");
        mcpTool.Description.ShouldBe("Find and list issues related to a specific JIRA issue through explicit links and keyword similarity. Returns both explicitly linked issues and keyword-related issues.");
